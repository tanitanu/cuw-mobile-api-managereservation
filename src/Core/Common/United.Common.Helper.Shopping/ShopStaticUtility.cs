...
namespace United.Common.Helper.Shopping
{
    public static class ShopStaticUtility
    {
        ...
        public static bool IsChangeEligible(United.Service.Presentation.ReservationResponseModel.ReservationDetail response)
        {
            try
            {
                bool.TryParse(response?.PNRChangeEligibility?.IsChangeEligible, out bool isChangeEligible);
                return isChangeEligible;
            }
            catch { return false; }
        }
