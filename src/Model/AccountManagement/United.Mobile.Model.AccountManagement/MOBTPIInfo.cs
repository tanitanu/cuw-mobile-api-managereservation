...
namespace United.Mobile.Model.MPSignIn
{
    ...
    public class MOBTPIInfo
    {
        ...
        private string offerHeaderV2 = string.Empty;
        private string offerTitleV2 = string.Empty;
        ...
        public string OfferHeaderV2
        {
            get
            {
                return this.offerHeaderV2;
            }
            set
            {
                this.offerHeaderV2 = string.IsNullOrEmpty(value) ? string.Empty : value.Trim();
            }
        }
        public string OfferTitleV2
        {
            get
            {
                return this.offerTitleV2;
            }
            set
            {
                this.offerTitleV2 = string.IsNullOrEmpty(value) ? string.Empty : value.Trim();
            }
        }
    }
}
