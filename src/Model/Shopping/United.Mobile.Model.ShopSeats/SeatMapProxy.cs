...
namespace United.Definition.SeatCSL30
{
    ...
    public partial class Pricing
    {
        ...
        [Newtonsoft.Json.JsonProperty("initialPrice", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class Traveler
    {
        ...
        [Newtonsoft.Json.JsonProperty("travelerPurchase", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TravelerPurchase TravelerPurchase { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.15.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class TravelerPurchase
    {
        [Newtonsoft.Json.JsonProperty("edoc", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Edoc { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("alreadyPurchasedAmount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AlreadyPurchasedAmount { get; set; }
    ...
    public partial class SeatMapRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("travelerSignInData", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TravelerSignInData TravelerSignInData { get; set; }
    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.15.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class TravelerSignInData
    {
        [Newtonsoft.Json.JsonProperty("signedInMPLevel", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SignedInMPLevel { get; set; }

        [Newtonsoft.Json.JsonProperty("signedInRPC", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SignedInRPC { get; set; }
    }
