...
namespace United.Mobile.Model.Shopping.Misc
{
    ...
    public class Seat
    {
        ...
        private string oldSeatLocation;
        private bool isEPA;
        ...
        public string OldSeatLocation
        {
            get { return this.oldSeatLocation; }
            set { this.oldSeatLocation = string.IsNullOrEmpty(value) ? string.Empty : value.Trim().ToUpper(); }
        }
